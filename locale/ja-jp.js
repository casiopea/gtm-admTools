var locale = {
    ...
    tooltip: {
        "gdeNavHref": "グローバル ディレクトリ エディタ",
        "mupipNavHref": "M ペリフェラル インターチェンジ プログラム",
        "lkeNavHref": "M ロック ユーティリティ",
        "mnuSysUtilsHref": "システム ユーティリティ",
        "FreeCntNavHref": "データベース フリーブロック サイズ",
        "GtmEnvNavHref": "GT.M環境変数",
        "aboutNavHref": "このシステムについて",
        "btnLogout": " さん ログアウト",
        "RegionTabPaneHref", "",
        "JournalTabPaneHref", "",
        "SegmentTabPaneHref", "",
